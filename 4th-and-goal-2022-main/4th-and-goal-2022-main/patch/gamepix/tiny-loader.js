...
})(
  {
    ...
    9: [
      function (e, t, n) {
        ...
        for (r in C) (o = (i = l[r]) && i.prototype) ? d(o, T, i) : (M = !1);
        ...
        if ((!M || !P || P === O) && ((P = R.prototype), M))
          for (r in C) l[r] && m(l[r].prototype, P);
        if ((M && v(A) !== P && m(A, P), s && !f(P, L)))
          for (r in ((U = !0),
          y(P, L, {
            get: function () {
      ...
      function (e, t, n) {
        ...
        t.exports = function (e, t, n, a, d, y, R) {
          ...
          var P,
            ...
            T = !1,
            M = e.prototype,
            U = M[x] || M["@@iterator"] || (d && M[d]),
            C = (!w && U) || L(d),
            _ = ("Array" == t && M.entries) || U;
          if (
            (_ &&
            ...
            if (
              ...
              for (E in O) (w || T || !(E in M)) && h(M, E, O[E]);
            else
              r(
                {
                  target: t,
            ...
            return [
              ...
              function (e, i) {
                ...
                for (var O, E = "", L = 0, I = 0; I < R.length; I++) {
                  ...
                  } else F = y(T, s, M, U, _, i);
                  M >= L && ((E += S(s, L, M) + F), (L = M + T.length));
                }
                return E + S(s, L);
              },
            ];
          ...
          (u(
            ue,
            {
              ...
              delete: function (e) {
                ...
                for (
                  var t = M(this), n = t.entries, r = x(e), i = 0;
                  i < n.length;
              ...
              get: function (e) {
                R(arguments.length, 1);
                for (
                  var t = M(this).entries, n = x(e), r = 0;
                  r < t.length;
                  r++
                )
              ...
              getAll: function (e) {
                R(arguments.length, 1);
                for (
                  var t = M(this).entries, n = x(e), r = [], i = 0;
                  i < t.length;
                  i++
                )
                ...
                ((t = (function (e) {
                  ...
                  for (n = [], r = 0; r < t; r++) {
                    ...
                    if (
                      ...
                      i.length > 1 &&
                        "0" == M(i, 0) &&
                        ((o = U(K, i) ? 16 : 8), (i = H(i, 8 == o ? 1 : 2))),
                      "" === i)
                    )
                      a = 0;
                    else {
                      if (!U(10 == o ? Z : 8 == o ? Q : ee, i)) return e;
                      a = L(i, o);
                    }
                    F(n, a);
                  }
    ...
    148: [
      function (e, t, n) {
        ...
        n.getConfigEndpoint =
          "patch/json/null.json?https://rt.gamepix.com/loader/config/get";
      },
      {},
    ],
    149: [
        ...
        n.HostInfo = class {
          ...
          getDeviceModel(e, t, n) {
            ...
            return t.match(/^apple+[a-zA-Z0-9_\s]+gpu$/i)
              ? this.getAppleDeviceModel(n)
              : this.getAndroidDeviceModel(navigator.userAgent);
          }
          updateWebGLInfo(e, t) {
