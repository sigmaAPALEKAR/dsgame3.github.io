      ...
      function (e, t, n) {
        ...
        if (s) {
          ...
          (O = (A = function (e) {
            d(this, O);
            var t = h(e);
            R(this, { bytes: W(N(t), 0), byteLength: t }),
              o || (this.byteLength = t);
          }).prototype),
            (C = (M = function (e, t, n) {
              d(this, C), d(e, O);
        ...
        j(A, k), j(M, E), (t.exports = { ArrayBuffer: A, DataView: M });
      },
      {
      ...
      function (e, t, n) {
        ...
        t.exports = function (e, t, n, s, h, y, I) {
          ...
          if (
            ...
            if (((k = { values: L(S), keys: y ? C : L(j), entries: L(_) }), I))
              for (E in k) (w || A || !(E in O)) && f(O, E, k[E]);
      ...
      function (e, t, n) {
        ...
        var r = e("../internals/export"),
          ...
          Z = function (e) {
            var t;
            return (
              S(F, e) || "ArrayBuffer" == (t = v(e)) || "SharedArrayBuffer" == t
            );
          },
          ee = function (e, t) {
              ...
              q
                ...
                : ((m = t(function (e, t, n, r) {
                    ...
                    if (w(t)) {
                      ...
                      if (void 0 === r) {
                        if (p % s) throw U(Y);
                        if ((a = p - d) < 0) throw U(Y);
                      } else if ((a = h(r) * s) + d > p) throw U(Y);
                      l = a / s;
                    } else (l = g(t)), (i = new W((a = l * s)));
                    for (
                      M(e, {
                        buffer: i,
                        byteOffset: d,
        ...
        class SDK {
            ...
            switch (
              ...
              case "partial":
                "ru" === this.host.systemInfo.language
                  ? alert(
                      "Вы используете устаревшую версию браузера. Пожалуйста обновите ваш браузер.\nМы не гарантируем корректную работу игры.",
                    )
                  : alert(
          ...
          initModule(e) {
            ...
            return (
              ...
              (e.pushException = this.exceptions.pushError.bind(
                this.exceptions,
              )),
