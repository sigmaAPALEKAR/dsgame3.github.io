    ...
    if (ballSnapped) {
      ...
      if (offensiveTeam == 1) {
        if (!this.getData("hasBall")) {
          if (
            this.y <
            team1RouteQB[this.getData("index")][1] + this.getData("startY")
          ) {
            this.y += this.getData("speed");
          }
          if (
          ...
          if (
            this.x <
            team1RouteQB[this.getData("index")][0] + this.getData("startX")
          ) {
            this.x += this.getData("speed");
          }
          if (
          ...
          if (
            Math.abs(
              this.x -
                (team1RouteQB[this.getData("index")][0] +
                  this.getData("startX")),
            ) <= this.getData("speed") &&
            Math.abs(
              this.y -
                (team1RouteQB[this.getData("index")][1] +
                  this.getData("startY")),
            ) <= this.getData("speed")
          ) {
            if (
              team1RouteQB.length == this.getData("index") + 1 &&
              this.getData("primaryTarget")
            ) {
              if (!ballPassed) {
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteFB[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteFB[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
      ...
      if (
        ...
        if (
          this.getData("index") == team1RouteFB.length - 1 &&
          defensiveTeam == 1
        ) {
...
class TB extends Player {
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (
        !this.getData("hasBall") &&
        !(kickOff && kickReturnTeam == 1) &&
        offensiveTeam == 1
      ) {
        if (
          this.y <
          team1RouteTB[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteTB[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
        ...
        if (
          ...
          if (
            team1RouteTB.length == this.getData("index") + 1 &&
            this.getData("primaryTarget")
          ) {
            this.setData("hasBall", true);
            inPlay = true;
      ...
      if (offensiveTeam == 2) {
        if (!inPlay) {
          ...
          if (
            Math.abs(
              this.x -
                (team1RouteTB[this.getData("index")][0] +
                  this.getData("startX")),
            ) <= this.getData("speed") &&
            Math.abs(
              this.y -
                (team1RouteTB[this.getData("index")][1] +
                  this.getData("startY")),
            ) <= this.getData("speed")
          ) {
            if (team1RouteTB.length > this.getData("index") + 1) {
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteWR1[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteWR1[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
      ...
      if (
        ...
        if (
          this.getData("index") == team1RouteWR1.length - 1 &&
          defensiveTeam == 1
        ) {
          this.setData("chasing", true);
        }
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteWR2[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteWR2[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
      ...
      if (
        ...
        if (
          this.getData("index") == team1RouteWR2.length - 1 &&
          defensiveTeam == 1
        ) {
          this.setData("chasing", true);
        }
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteWR3[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteWR3[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
      ...
      if (
        ...
        if (
          this.getData("index") == team1RouteWR3.length - 1 &&
          defensiveTeam == 1
        ) {
          this.setData("chasing", true);
        }
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteLT[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteLT[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
      ...
      if (
        ...
        if (
          this.getData("index") == team1RouteLT.length - 1 &&
          defensiveTeam == 1
        ) {
          this.setData("chasing", true);
        }
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteLG[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteLG[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
      ...
      if (
        ...
        if (
          this.getData("index") == team1RouteLG.length - 1 &&
          defensiveTeam == 1
        ) {
          this.setData("chasing", true);
        }
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteC[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteC[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
      ...
      if (
        ...
        if (
          this.getData("index") == team1RouteC.length - 1 &&
          defensiveTeam == 1
        ) {
          this.setData("chasing", true);
        }
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteRG[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteRG[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
      ...
      if (
        ...
        if (
          this.getData("index") == team1RouteRG.length - 1 &&
          defensiveTeam == 1
        ) {
          this.setData("chasing", true);
        }
  ...
  update() {
    ...
    if (ballSnapped) {
      ...
      if (!this.getData("hasBall") && !this.getData("chasing")) {
        if (
          this.y <
          team1RouteRT[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team1RouteRT[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
...
class DB1 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteDB1[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteDB1[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
...
class DB2 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteDB2[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteDB2[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
  ...
  update() {
    ...
    if (defensiveTeam == 2) {
      if (ballSnapped && !this.getData("chasing")) {
        ...
        if (
          this.y <
          team2RouteSS[this.getData("index")][1] + this.getData("startY")
        ) {
          this.y += this.getData("speed");
        }
        if (
        ...
        if (
          this.x <
          team2RouteSS[this.getData("index")][0] + this.getData("startX")
        ) {
          this.x += this.getData("speed");
        }
        if (
    ...
    if (this.getData("hasBall")) {
      ...
      if (team2Play == "sweepLt") {
        this.runningSpeed =
          this.getData("speedOriginal") - (1 - this.getData("health") / 100);
        if (this.x < 580) {
...
class FS extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteFS[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteFS[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
...
class LB1 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteLB1[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteLB1[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
...
class LB2 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteLB2[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteLB2[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
    ...
    if (difficulty == 2.4) {
      //LB following play Hall of Fame mode
...
class LB3 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteLB3[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteLB3[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
...
class DL1 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteDL1[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteDL1[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
...
class DL2 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteDL2[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteDL2[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
...
class DL3 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteDL3[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteDL3[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
...
class DL4 extends Player {
  ...
  update() {
    ...
    if (ballSnapped && !this.getData("chasing")) {
      ...
      if (
        this.y <
        team2RouteDL4[this.getData("index")][1] + this.getData("startY")
      ) {
        this.y += this.getData("speed");
      }
      if (
      ...
      if (
        this.x <
        team2RouteDL4[this.getData("index")][0] + this.getData("startX")
      ) {
        this.x += this.getData("speed");
      }
      if (
