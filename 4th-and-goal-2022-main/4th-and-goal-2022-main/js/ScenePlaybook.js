class ScenePlaybook extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image(
      "playbookBgOffenseFormations",
      "content/playbookBgOffenseFormations.png",
    );
    this.load.image(
      "playbookBgOffensePlaysSplit",
      "content/playbookBgOffensePlaysSplit.png",
    );
    this.load.image(
      "playbookBgOffensePlaysI",
      "content/playbookBgOffensePlaysI.png",
    );
    this.load.image(
      "playbookBgOffensePlaysShotgun",
      "content/playbookBgOffensePlaysShotgun.png",
    );
    this.load.image(
      "playbookBgOffensePlaysBunch",
      "content/playbookBgOffensePlaysBunch.png",
    );
    this.load.image(
      "playbookBgOffensePlaysAce",
      "content/playbookBgOffensePlaysAce.png",
    );
    this.load.image(
      "playbookBgOffensePlaysEmpty",
      "content/playbookBgOffensePlaysEmpty.png",
    );
    ...
    this.load.image(
      "playbookBgSpecialTeams",
      "content/playbookBgSpecialTeams.png",
    );
    ...
    this.load.image(
      "playbookBgSpecials",
      "content/playbookSpecialsOffense.png",
    );
  ...
  create() {
    ...
    this.graphics2.lineGradientStyle(
      200,
      0xff0000,
      0xff0000,
      0x0000ff,
    ...
    this.bgOffenseFormations = this.add.image(
      0,
      0,
      "playbookBgOffenseFormations",
    );
    ...
    this.bgOffensePlaysSplit = this.add.image(
      0,
      0,
      "playbookBgOffensePlaysSplit",
    );
    this.bgOffensePlaysSplit.setOrigin(0, 0);
    this.bgOffensePlaysShotgun = this.add.image(
      0,
      0,
      "playbookBgOffensePlaysShotgun",
    );
    this.bgOffensePlaysShotgun.setOrigin(0, 0);
    this.bgOffensePlaysBunch = this.add.image(
      0,
      0,
      "playbookBgOffensePlaysBunch",
    );
    ...
    this.bgOffensePlaysEmpty = this.add.image(
      0,
      0,
      "playbookBgOffensePlaysEmpty",
    );
    ...
    this.kickOffPlaybook.add([
      this.bgKickOffPlaybook,
      this.btnDeepKick,
      this.btnOnsideKick,
      this.btnKickOffKick,
    ]);
    ...
    this.containerPAT.add([
      this.bgPAT,
      this.btn2ptConversion,
      this.btnExtraPoint,
      this.btnExtraPointKick,
      this.trianglePath,
      this.triangle,
    ]);
    this.containerPAT.visible = false;

    this.offensivePlaybook.add([
      this.bgOffensePlaysI,
      this.bgOffensePlaysSplit,
      this.bgOffensePlaysShotgun,
      this.bgOffensePlaysBunch,
      this.bgOffensePlaysAce,
      this.bgOffensePlaysEmpty,
      this.bgOffensePlaysRedZone,
      this.bgOffensePlaysSpecials,
      this.bgOffenseFormations,
    ]);
    this.offensivePlaybook.add([
      this.btnSplit,
      this.btnIFormation,
    ...
    this.containerBigHit.add([
      this.bgCrowd,
      this.bigHitText,
      this.bigHittie,
      this.bigHitter,
      this.scoreboardMask2,
    ]);
    this.containerBigHit.visible = false;

    this.containerFumble.add([
      this.fumbleBg,
      this.fumblePlayer,
      this.fumblePlayer2,
      this.fumbleBall,
      this.scoreboardMask6,
    ]);
    this.containerFumble.visible = false;

    this.containerGoodD.add([
      this.bgCrowd2,
      this.goodD,
      this.goodDFootball,
      this.goodDText,
      this.scoreboardMask3,
    ]);
    this.containerGoodD.visible = false;

    this.containerInterception.add([
      this.bgCrowd3,
      this.interception,
      this.interceptionText,
      this.goodDFootball2,
      this.scoreboardMask4,
    ]);
    this.containerInterception.visible = false;

    this.containerConversionGood.add([
      this.bgTD2,
      this.graphics2,
      this.cheerleader3,
      this.cheerleader4,
      this.conversionGoodMC,
      this.scoreboardMask5,
    ]);
  ...
  update() {
    ...
    if (openOffensivePlaybook) {
      ...
      if (
        yardlinePixel <= 420 &&
        !openOffensivePlaysSplit &&
        !openOffensivePlaysI &&
        !openOffensivePlaysShotgun &&
        !openOffensivePlaysBunch &&
        !openOffensivePlaysAce &&
        !openOffensivePlaysEmpty &&
        !openOffensivePlaysSpecials
      ) {
        this.buttonRedZone.visible = true;
      }
      if (
  ...
  setRoutes() {
    ...
    if (team1Play == "sweepLt") {
      ...
      team1RouteWR1 = [[0, -distTd]];
      team1RouteWR2 = [
        [-10, 0],
        [-20, -20],
        [-20, -distTd],
      ];
      team1RouteWR3 = [[-20, -distTd]];
      team1RouteFB = [
        [-60, -60],
        [-60, -distTd],
      ];
    ...
    if (team1Play == "powerRt") {
      ...
      team1RouteWR1 = [[20, -distTd]];
      team1RouteWR2 = [
        [-10, -10],
        [-20, -20],
        [-20, -distTd],
      ];
      team1RouteWR3 = [[-3, -distTd]];
      team1RouteFB = [
        [50, -50],
        [60, -60],
        [75, -75],
    ...
    if (team1Play == "zoneRt") {
      ...
      team1RouteWR1 = [[0, -distTd]];
      team1RouteWR2 = [[0, -distTd]];
      team1RouteWR3 = [[-5, -distTd]];
      team1RouteFB = [
        [-20, -20],
        [-20, -distTd],
      ];
    ...
    if (team2Play == "sweepLt") {
      team2RouteDB1 = [[0, distTd2]];
      team2RouteDB2 = [[0, distTd2]];
      team2RouteFS = [
        [20, 10],
        [40, distTd2],
      ];
      team2RouteLB2 = [[0, -40]];
      team2RouteLB3 = [[40, 600]];
      team2RouteSS = [
        [30, 0],
        [30, 0],
        [150, 0],
