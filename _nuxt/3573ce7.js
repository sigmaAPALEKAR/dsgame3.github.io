        ...
        !(function () {
          ...
          r.prototype = {
            ...
            volume: function (e) {
              ...
              if (
                ...
                n.usingWebAudio &&
                  n.masterGain.gain.setValueAtTime(e, d.ctx.currentTime);
                for (var i = 0; i < n._howls.length; i++)
                  if (!n._howls[i]._webAudio)
                    for (
                      var t = n._howls[i]._getSoundIds(), o = 0;
                      o < t.length;
                      o++
                    ) {
                ...
                var n = function (t) {
                  ...
                  for (var i = 0; i < e._howls.length; i++)
                    if (!e._howls[i]._webAudio)
                      for (
                        var r = e._howls[i]._getSoundIds(), d = 0;
                        d < r.length;
                        d++
                      ) {
                        ...
                        _ &&
                          _._node &&
                          !_._node._unlocked &&
                          ((_._node._unlocked = !0), _._node.load());
                      }
                  e._autoResume();
          ...
          _.prototype = {
            ...
            play: function (e, n) {
              ...
              var c = Math.max(
                  0,
                  _._seek > 0 ? _._seek : t._sprite[e][0] / 1e3,
                ),
              ...
              if (!(c >= h)) {
                ...
                if (t._webAudio) {
                  var w = function () {
                    ...
                    y.gain.setValueAtTime(e, d.ctx.currentTime),
                      ...
                      void 0 === y.bufferSource.start
                        ? _._loop
                          ? y.bufferSource.noteGrainOn(0, c, 86400)
                          : y.bufferSource.noteGrainOn(0, c, f)
                        : _._loop
                          ? y.bufferSource.start(0, c, 86400)
                          : y.bufferSource.start(0, c, f),
                      m !== 1 / 0 &&
                        (t._endTimers[_._id] = setTimeout(
                          t._ended.bind(t, _),
                          m,
                        )),
                      n ||
                  ...
                  "running" === d.state && "interrupted" !== d.ctx.state
                    ? w()
                    : ((t._playLock = !0),
                      t.once("resume", w),
                      t._clearTimer(_._id));
                    ...
                    try {
                      ...
                      if (
                        ...
                        (o instanceof Promise || "function" == typeof o.then)
                          ...
                          : n ||
                            ((t._playLock = !1), A(), t._emit("play", _._id)),
                        (y.playbackRate = _._rate),
                        y.paused)
                      )
                        return void t._emit(
                  ...
                  "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" ===
                    y.src && ((y.src = t._src), y.load());
                  var x =
                    (window && window.ejecta) ||
                    (!y.readyState && d._navigator.isCocoonJS);
            ...
            mute: function (e, n) {
              ...
              for (var o = t._getSoundIds(n), i = 0; i < o.length; i++) {
                ...
                r &&
                  ...
                  t._webAudio && r._node
                    ? r._node.gain.setValueAtTime(
                        e ? 0 : r._volume,
                        d.ctx.currentTime,
                      )
                    : r._node && (r._node.muted = !!d._muted || e),
                  t._emit("mute", r._id));
              }
              return t;
            },
              ...
              for (var i = 0; i < n.length; i++)
                (t = o._soundById(n[i])) &&
                  ...
                  o._webAudio && t._node && !t._muted
                    ? t._node.gain.setValueAtTime(e, d.ctx.currentTime)
                    : t._node && !t._muted && (t._node.volume = e * d.volume()),
            ...
            _stopFade: function (e) {
              ...
              return (
                t &&
                  t._interval &&
                  (n._webAudio &&
                    t._node.gain.cancelScheduledValues(d.ctx.currentTime),
            ...
            unload: function () {
              ...
              for (i = 0; i < d._howls.length; i++)
                if (
                  d._howls[i]._src === e._src ||
                  e._src.indexOf(d._howls[i]._src) >= 0
                ) {
                  o = !1;
                  break;
                }
            ...
            _refreshBuffer: function (e) {
              return (
                (e._node.bufferSource = d.ctx.createBufferSource()),
            ...
            _clearSound: function (e) {
              /MSIE |Trident\//.test(d._navigator && d._navigator.userAgent) ||
                (e.src =
                  "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA");
            },
          };
          ...
          l.prototype = {
            ...
            create: function () {
              ...
              return (
                n._webAudio
                  ? ((e._node =
                      void 0 === d.ctx.createGain
                        ? d.ctx.createGainNode()
                        : d.ctx.createGain()),
                    e._node.gain.setValueAtTime(t, d.ctx.currentTime),
                    (e._node.paused = !0),
                    e._node.connect(d.masterGain))
                  : d.noAudio ||
                    ((e._node = d._obtainHtml5Audio()),
          ...
          var c = {},
            f = function (e) {
              ...
              if (/^data:[^;]+;base64,/.test(n)) {
                for (
                  var data = atob(n.split(",")[1]),
                    t = new Uint8Array(data.length),
                    i = 0;
                  i < data.length;
                  ++i
                )
            ...
            v = function (e, n) {
              ...
              "undefined" != typeof Promise &&
              1 === d.ctx.decodeAudioData.length
                ? d.ctx.decodeAudioData(e).then(o).catch(t)
                : d.ctx.decodeAudioData(e, o, t);
            },
            h = function (e, n) {
            ...
            A = function () {
              if (d.usingWebAudio) {
                ...
                var e = /iP(hone|od|ad)/.test(
                    d._navigator && d._navigator.platform,
                  ),
                  n =
                    d._navigator &&
                    d._navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/),
                  t = n ? parseInt(n[1], 10) : null;
                if (e && t && t < 9) {
                  var o = /safari/.test(
                    d._navigator && d._navigator.userAgent.toLowerCase(),
                  );
            ...
            (HowlerGlobal.prototype._pos = [0, 0, 0]),
              ...
              (HowlerGlobal.prototype.orientation = function (
                ...
                return (
                  ...
                  "number" != typeof e
                    ? l
                    : ((_._orientation = [e, n, t, o, r, d]),
                      void 0 !== _.ctx.listener.forwardX
                        ? (_.ctx.listener.forwardX.setTargetAtTime(
                            e,
                            Howler.ctx.currentTime,
                            0.1,
                          ),
                          _.ctx.listener.forwardY.setTargetAtTime(
                            n,
                            Howler.ctx.currentTime,
                            0.1,
                          ),
                          _.ctx.listener.forwardZ.setTargetAtTime(
                            t,
                            Howler.ctx.currentTime,
                            0.1,
                          ),
                          _.ctx.listener.upX.setTargetAtTime(
                            o,
                            Howler.ctx.currentTime,
                            0.1,
                          ),
                          _.ctx.listener.upY.setTargetAtTime(
                            r,
                            Howler.ctx.currentTime,
                            0.1,
                          ),
                          _.ctx.listener.upZ.setTargetAtTime(
                            d,
                            Howler.ctx.currentTime,
                            0.1,
                          ))
                        : _.ctx.listener.setOrientation(e, n, t, o, r, d),
                      _)
                );
              }),
              (Howl.prototype.init =
                ...
                for (var d = o._getSoundIds(t), i = 0; i < d.length; i++) {
                  ...
                  if (_) {
                    ...
                    (_._stereo = e),
                      (_._pos = [e, 0, 0]),
                      _._node &&
                        ((_._pannerAttr.panningModel = "equalpower"),
                        (_._panner && _._panner.pan) || n(_, r),
                        "spatial" === r
                          ? void 0 !== _._panner.positionX
              ...
              (Howl.prototype.orientation = function (e, t, o, r) {
                ...
                if (
                  ((t = "number" != typeof t ? d._orientation[1] : t),
                    ...
                    (l._orientation = [e, t, o]),
                      l._node &&
                        ...
                        void 0 !== l._panner.orientationX
                          ...
                          : l._panner.setOrientation(e, t, o)),
              ...
              (Howl.prototype.pannerAttr = function () {
                ...
                if (1 === d.length) {
                  if ("object" != typeof d[0])
                    return (o = r._soundById(parseInt(d[0], 10)))
                      ? o._pannerAttr
                      : r._pannerAttr;
                  (e = d[0]),
                    void 0 === t &&
