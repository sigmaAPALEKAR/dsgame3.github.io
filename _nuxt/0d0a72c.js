  ...
  [1],
  {
        ...
        return new Promise(function (t, n) {
          ...
          if (
            (j.open(
              ...
              f(A, e.params, e.paramsSerializer),
              !0,
            ),
            (j.timeout = e.timeout),
            "onloadend" in j
              ...
              : (j.onreadystatechange = function () {
                  j &&
                    ...
                    (0 !== j.status ||
                      (j.responseURL &&
                        0 === j.responseURL.indexOf("file:"))) &&
                    setTimeout(R);
                }),
            (j.onabort = function () {
              j && (n(m("Request aborted", e, "ECONNABORTED", j)), (j = null));
            }),
            (j.onerror = function () {
              n(m("Network Error", e, null, j)), (j = null);
            }),
            ...
            var T =
              (e.withCredentials || h(A)) && e.xsrfCookieName
          ...
          "setRequestHeader" in j &&
            r.forEach(E, function (e, t) {
              void 0 === x && "content-type" === t.toLowerCase()
                ? delete E[t]
                : j.setRequestHeader(t, e);
            }),
            r.isUndefined(e.withCredentials) ||
              (j.withCredentials = !!e.withCredentials),
            S && "json" !== S && (j.responseType = e.responseType),
            "function" == typeof e.onDownloadProgress &&
              j.addEventListener("progress", e.onDownloadProgress),
            "function" == typeof e.onUploadProgress &&
              j.upload &&
              j.upload.addEventListener("progress", e.onUploadProgress),
            (e.cancelToken || e.signal) &&
              ((w = function (e) {
                j &&
                  (n(!e || (e && e.type) ? new y("canceled") : e),
                  j.abort(),
                  (j = null));
              }),
    ...
    783: function (e, t, n) {
      ...
      (l.Axios = c),
        ...
        (l.CancelToken = n(797)),
        (l.isCancel = n(446)),
        (l.VERSION = n(448).version),
        (l.all = function (e) {
          return Promise.all(e);
        }),
        (l.spread = n(798)),
        (l.isAxiosError = n(799)),
        (e.exports = l),
        (e.exports.default = l);
    },
    784: function (e, t, n) {
      ...
      (m.prototype.request = function (e) {
        ...
        r.forEach(["post", "put", "patch"], function (e) {
          m.prototype[e] = function (t, data, n) {
            return this.request(l(n || {}, { method: e, url: t, data: data }));
          };
        }),
        (e.exports = m);
    },
