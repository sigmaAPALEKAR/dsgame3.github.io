...
if (0 <= window.location.href.indexOf("pokiForceLocalLoader") && (loaders.unity = "/unity/dist/unity.js", loaders["unity-beta"] = "/unity-beta/dist/unity-beta.js", console.log("test tessssssssssssst"), root = "/loaders"), !window.config) throw Error("window.config not found");
